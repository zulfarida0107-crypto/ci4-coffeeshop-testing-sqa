...
<div class="w-full flex-1 flex flex-col">
    ...
    <div class="flex justify-between items-end mb-lg">
        <div>
            ...
            <h1 class="font-h1 text-h1 text-on-surface">Tambah Daftar Menu</h1>
        </div>
    ...
    <div class="glass-card rounded-xl p-xl shadow-sm border border-outline-variant/30">
        <form action="<?= base_url('menu-produk/store') ?>" method="POST" class="space-y-lg">
            <?= csrf_field() ?>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-lg">
                <div class="space-y-sm">
                    <label class="font-label-md text-label-md text-on-surface-variant block">Nama Produk</label>
                    <input type="text" name="nama_produk" class="glass-input w-full px-md py-sm rounded-lg text-on-surface placeholder:text-outline-variant/50 focus:ring-2 focus:ring-primary/20" placeholder="Masukkan nama kopi/kue..." required>
                </div>
                ...
                <div class="space-y-sm">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga" class="glass-input w-full pl-xl pr-md py-sm rounded-lg text-on-surface placeholder:text-outline-variant/50 focus:ring-2 focus:ring-primary/20" placeholder="25000" required>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-sm">
                ...
                <textarea name="deskripsi" class="glass-input w-full p-md rounded-lg text-on-surface resize-none leading-relaxed min-h-[120px] focus:ring-2 focus:ring-primary/20" placeholder="Ceritakan sedikit tentang rasa produk ini..."></textarea>
            </div>
